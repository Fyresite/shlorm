...
/*#__PURE__*/
function (_React$Component) {
  src_inherits(Shlorm, _React$Component);

  function Shlorm(props) {
    var _this;

    src_classCallCheck(this, Shlorm);
  ...
  src_createClass(Shlorm, [{
    ...
    value: function getForm() {
      ...
      Object.keys(this.state).forEach(function (key) {
        if (key !== "submitted") form[key] = _this2.state[key].value;
      });
      return form;
    }
  }, {
...
src_Shlorm.displayName = "Shlorm";

/* harmony default export */ var src = __webpack_exports__["default"] = (src_Shlorm);
